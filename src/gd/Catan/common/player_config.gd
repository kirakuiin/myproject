...
func save_icon(icon_path: String):
    _config.set_value(PLAYER_SECTION, "player_avatar", icon_path)
    _config.save(CONFIG_PATH)
...
func get_icon_path() -> String:
    return _config.get_value(PLAYER_SECTION, "player_avatar", "res://assets/icons/nyx.png")
