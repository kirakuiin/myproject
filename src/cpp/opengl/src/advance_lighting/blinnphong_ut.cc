...
class BPHUT : public testing::Test {
  public:
...
TEST_F(BPHUT, HelloBlinnPhong) {
    ...
    // set shader
    gl::VertexShader v_shader("shaders/advancelighting/shader.vert");
    gl::FragmentShader f_shader("shaders/advancelighting/shader.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        program.SetUniform("alightpos", vec3(5, 5, 5));
        // cubes
        glBindVertexArray(c_vao);
