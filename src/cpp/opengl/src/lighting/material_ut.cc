...
class MATUT : public testing::Test {
  public:
...
TEST_F(MATUT, HelloMaterial) {
    ...
    // set shader
    gl::VertexShader v_shader("shaders/materials/vertex_shader.gls");
    gl::FragmentShader of_shader("shaders/materials/of_shader.gls");
    gl::FragmentShader lf_shader("shaders/materials/lf_shader.gls");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        obj_program.SetUniform("material.ambient", vec3(1, 0.5, 0.31));
        obj_program.SetUniform("material.diffuse", vec3(1, 0.5, 0.31));
        obj_program.SetUniform("material.specular", vec3(0.5, 0.5, 0.5));
        ...
        obj_program.SetUniform("light.ambient", vec3(0.1, 0.1, 0.1));
