...
class SADUT : public testing::Test {
  public:
...
TEST_F(SADUT, HelloShader) {
    ...
    gl::VertexShader v_shader("shaders/shader/vertex_shader_uni.gls");
    gl::FragmentShader f_shader("shaders/shader/fragment_shader_uni.gls");
